      ...
      <div className="container header__container">
        <div className="header__wrapper">
          <div className="header__logo">
            <div className="logo">
              <img className="logo__img" src="img/logo_welbex.png" alt="Logo" />
              <p className="logo__title title-3">
        ...
        <div className="header__contacts">
          <div className="contacts">
            ...
            <ul className="contacts__socials socials-list contacts__socials--header">
