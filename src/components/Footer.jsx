        ...
        <div className="footer__wrapper">
          <div className="footer__inner">
            <div className="footer__about about">
              <h3 className="about__title heading-footer">О компании</h3>
          ...
          <div className="footer__contacts contacts contacts--footer">
            <h3 className="contacts__title heading-footer heading-footer--contacts">
              Контакты
            </h3>
            <span className="contacts__phone">+7 555 555-55-55</span>
            <ul className="contacts__socials socials-list socials-list--footer">
            ...
            <span className="contacts__addres">
              Москва, Путевой проезд 3с1, к 902
            </span>
          </div>
        </div>
        <div className="footer__copyright copyright title-3">
          <p className="copyright__text">©WELBEX 2022. Все права защищены.</p>
